        ...
        <div id="news_area">
            ...
            <div class="block_body">
                ...
                <!--{assign var="date_array" value="-"|explode:$arrNews[data].cast_news_date}-->
                    ...
                    <!--{assign var="finish_date_array" value="-"|explode:$arrNews[data].cast_finish_date}-->
                <dl class="newslist">
                    <dt><!--{$date_array[0]}-->年<!--{$date_array[1]}-->月<!--{$date_array[2]}-->日<!--{$arrNews[data].cast_start_date}--></dt>
                    <dt>
                        <a
