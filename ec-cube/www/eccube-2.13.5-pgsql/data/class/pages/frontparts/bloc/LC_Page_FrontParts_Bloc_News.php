...
class LC_Page_FrontParts_Bloc_News extends LC_Page_FrontParts_Bloc_Ex
{
    ...
    {
        /*ニュースを管理するヘルパークラスをインスタンス化*/
        $objNews = new SC_Helper_News_Ex();
        /*ニュースを管理するクラスをインスタンス化*/
        ...
        switch ($this->getMode()) {
            ...
            case 'getDetail':
                ...
                break;
            default:
                /*getListをgetlimitListに変更*/
                $this->arrNews = $objNews->getlimitList();
    ...
    {
        /*getListをgetlimitListに変更*/
        $arrNewsList = $objNews->getlimitList($dispNumber, $pageNo);
