<?php
/* Smarty version 3.1.32-dev-38, created on 2018-01-16 09:48:02
  from '/vagrant/www/board/templates/show.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32-dev-38',
  'unifunc' => 'content_5a5dca526a87a5_05476775',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '11355d0069677e4d144b176f1a392bdda9f71fdb' => 
    array (
      0 => '/vagrant/www/board/templates/show.html',
      1 => 1516096018,
      2 => 'file',
    ),
  ),
...
function content_5a5dca526a87a5_05476775 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="ja">
    <head>
        <meta charset="UTF-8">
 ...
 さん <input type="button" onclick="location.href='./logout.php'"value="ログアウト"><br>
            <input type="button" onclick="location.href='./user_create.php'"value="新規登録"><br>
        ...
        <?php } else { ?>
            ...
            <input type="button" onclick="location.href='./user_create.php'"value="新規登録">
            <input type="button" onclick="location.href='./login.php'"value="ログイン"><br>
