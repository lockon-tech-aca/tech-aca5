        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <option value="" selected="selected">----</option>
                    <!--{html_options options=$arr_start_Year selected=$arrForm_start.start_year.value}-->
                    </select>年
                    ...
                    <option value="" selected="selected">--</option>
                    <!--{html_options options=$arr_start_Month selected=$arrForm_start.start_month.value}-->
                    </select>月
                    ...
                    <option value="" selected="selected">--</option>
                    <!--{html_options options=$arr_start_Day selected=$arrForm_start.start_day.value}-->
                    </select>日
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <option value="" selected="selected">----</option>
                    <!--{html_options options=$arr_end_Year selected=$arrForm_end.end_year.value}-->
                    </select>年
                    ...
                    <option value="" selected="selected">--</option>
                    <!--{html_options options=$arr_end_Month selected=$arrForm_end.end_month.value}-->
                    </select>月
                    ...
                    <option value="" selected="selected">--</option>
                    <!--{html_options options=$arr_end_Day selected=$arrForm_end.end_day.value}-->
                    </select>日
                </td>
            </tr>
